...
def demo_recon_synthetic_KAIST():
    ...
    iters_ADMM = 20
    iters_ADAM = 200
    filename_test = './inputs/synthetic/KAIST/yxr05.mat'
    out_filename = './outputs/recon_synthetic/yxr05_recon.mat'
    out_coded_img_filename = './outputs/recon_synthetic/yxr05_coded_img.png'
    summary_dir = './outputs/recon_synthetic/yxr05_recon_summary'
